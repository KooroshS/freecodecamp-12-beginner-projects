# Our Markov Chain representation is going to be here
import random
...
class Vertex:
    ...
    def next_word(self):
        # randomly select next word ***BAsed won weights!
...
class Graph:
    ...
    def get_vertex(self, value):
        ...
        return self.vertices[value] # get the vertex object and return it
